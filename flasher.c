...
int32_t part;
uint32_t blk,maxblock,tt;
//SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 15);
printf("\n  WAIT FOR COMPLETE FLASH BY CHAPPIE\n\n");
//printf("\n                                     PLEASE WAIT FOR FLASHING TO COMPLETE\n\n");
// The main cycle of recording partitions

for(part=0;part<npart;part++) {
printf("\r");//yeha apka \n hoga n ke jgha r likh dena DONE 100%
//printf("\r");
//  printf("\n02i %s)",part,ptable[part].pname);
 ...
 for(blk=0;blk<maxblock;blk++) {
  ...
  printf("\r %-5s  %02i   %i%%","  BLOCK "/* ptable[part].pname*/,part, (blk+1) * 100 / maxblock);
